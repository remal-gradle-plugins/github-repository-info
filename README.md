...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->8.0<!--/property--> to <!--property:gradle-api.max-version-->9.6.1<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.github-repository-info' version '1.1.0'
}
```
<!--/plugin-usage-->
